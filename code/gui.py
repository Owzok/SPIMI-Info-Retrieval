...
if os.getcwd()[-5:-1] != "code":
    print("[Error] You are running the program in an invalid folder.")
...
class GUI:
    def __init__(self):
        ...
        self.q_rect = pygame.Rect(35, 140, 1325, 60)
        self.k_rect = pygame.Rect(1210, 45, 70, 35)
        self.BUTTON_RECT = pygame.Rect(1290, 45, 60, 35)
    ...
    def render_results(self):
        for i, result in enumerate(self.our_results):
            ...
            self.draw_text(str(result[1]), self.our_results_rect.x + 250, self.our_results_rect.y + 10 + (i * 25), self.BLACK, font_size=14)
        ...
        for i, result in enumerate(self.pg_results):
            ...
            self.draw_text(str(result[1]), self.pg_results_rect.x + 250, self.pg_results_rect.y + 10 + (i * 25), self.BLACK, font_size=14)
    ...
    def perform_search(self):
        ...
        self.our_results = spimi.search_query(self.query, self.top_k)
        ans = ""
        #for doc_id, document in enumerate(documents): #martin, que hace esto? > esto lo usaba antes para sacar el mejor resultado o si habian resultados
    ...
    def render_interface(self):
        ...
        # Top panel
        top_rect = pygame.Rect(30, 35, 1335, 650)
        ...
        # Query bar
        query_bar_rect = pygame.Rect(30, 95, 1335, 40)
        ...
        self.draw_text("tf-idf", self.our_results_rect_head.x + 250, self.our_results_rect_head.y + 73, self.BLACK, font_size=15)
        ...
        self.draw_text("score", self.pg_results_rect_head.x + 250, self.pg_results_rect_head.y + 73, self.BLACK, font_size=15)
        # --
        self.render_results()
        '''
        if self.b_result == "":
